...
class LegendaryTelegramBot:
    ...
    async def send_signal(self, alert_data: Dict):
        """Send signal alert"""
    ...
    while True:
        try:
            ...
            for asset in ASSETS:
                ...
                for tf in ["1d", "4h", "1h", "15m", "5m"]:  # Simplified for reliability
                    try:
                ...
                for expiry in EXPIRIES:
                    ...
                    if (result['confidence'] >= threshold and
                        ...
                        if telegram.initialized:
                            await telegram.send_signal(alert_data)
...
async def main():
    ...
    scanner_task = asyncio.create_task(main_scan_loop())
