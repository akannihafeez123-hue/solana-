...
# Telegram setup - SIMPLIFIED VERSION
...
class SimpleTelegramBot:
    def __init__(self, token: str, chat_id: str):
        ...
        try:
            ...
            print("📝 Make sure TELEGRAM_TOKEN and CHAT_ID are set correctly in .env file")
...
def main_scan_loop():
    ...
    telegram = SimpleTelegramBot(TELEGRAM_TOKEN, CHAT_ID)
