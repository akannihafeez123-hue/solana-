...
def check_and_install_packages():
    ...
    if missing_packages:
        ...
        print("Please install them via Replit Packages or run:")
...
if not check_and_install_packages():
    print("⚠️ Some packages are missing. The bot may not work properly.")
    print("Please install the missing packages and restart.")
